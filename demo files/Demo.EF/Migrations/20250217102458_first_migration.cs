    ...
    public partial class first_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "test@test.be", "Author 1" },
                    { 2, "demo@test.com", "Author 2" }
                });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "AuthorId", "BorrowerId", "Isbn", "Publisher", "Title" },
                values: new object[,]
                {
                    { 1, 1, null, "1234567890", null, "Book 1" },
                    { 2, 2, null, "0987654321", null, "Book 2" }
                });
